 ...
 */
const ServicioCreateModal = ({ isOpen, onClose, onCreate, loading, apiError, categorias }) => {
...
ServicioCreateModal.defaultProps = {
  loading: false,
  apiError: null,
  categorias: [],
};

export default ServicioCreateModal;