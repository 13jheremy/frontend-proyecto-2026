 ...
 */
const ProveedorEditModal = ({ isOpen, onClose, onUpdate, currentProveedor = null, loading = false, apiError = null }) => {
    ...
    <Modal isOpen={isOpen} onClose={onClose} title={`Editar Proveedor: ${currentProveedor.nombre}`}>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* NIT */}
          <div>
            <label htmlFor="nit-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          {/* Contacto Principal */}
          <div>
            <label htmlFor="contacto_principal-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          {/* Teléfono */}
          <div>
            <label htmlFor="telefono-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <div className="md:col-span-2">
            <label htmlFor="correo-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          {/* Dirección */}
          <div className="md:col-span-2">
            <label htmlFor="direccion-edit" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
...
ProveedorEditModal.propTypes = {
  ...
  currentProveedor: PropTypes.object,
