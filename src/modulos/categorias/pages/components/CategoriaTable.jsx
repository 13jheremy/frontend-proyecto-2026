// src/modulos/servicios/pages/components/CategoriaTable.jsx
import React from 'react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import {
  faEdit, faTrash, faListAlt, faCheckCircle, faBan,
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500 dark:text-gray-400">
          Comienza registrando tu primera categoría o ajusta los filtros de búsqueda.
        </p>
      </div>
    );
  }
            ...
            >
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <div className="flex items-center space-x-2">
                  ...
                  {!categoria.eliminado && (
                    <button
                      onClick={() => onToggleActive && onToggleActive(categoria.id, !categoria.activo)}
