// src/modulos/inventario/pages/components/MovimientoSearch.jsx
...
const MovimientoSearch = ({ filters = {}, setFilters, onSearch }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-2">
          <div className="relative">
            <input
              type="text"
              placeholder="Buscar por motivo, producto o usuario..."
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          {filters.tipo === 'ajuste' && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-200">
              <FontAwesomeIcon icon={faAdjust} className="mr-1 h-3 w-3" />
              Ajustes
              <button
                type="button"
                onClick={() => handleInputChange('tipo', '')}
          ...
          {filters.fecha_inicio && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-200">
              ...
              <button
                type="button"
                onClick={() => handleInputChange('fecha_inicio', '')}
          ...
          {filters.fecha_fin && (
            <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-200">
              ...
              <button
                type="button"
                onClick={() => handleInputChange('fecha_fin', '')}
...
MovimientoSearch.propTypes = {
  filters: PropTypes.object,
  setFilters: PropTypes.func.isRequired,
  onSearch: PropTypes.func.isRequired,
};

export default MovimientoSearch;
